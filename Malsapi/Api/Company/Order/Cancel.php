 ...
 * @author: Dm
 */
class Api_Company_Order_Cancel extends PhalApi_Api {
    ...
    public function Go() {
        ...
        //判断订单服务状态
        if(($orderInfo['service_status'] == 'work' || $orderInfo['service_status'] == 'finish' || $orderInfo['service_status'] == 'cancel' || $orderInfo['service_status'] == 'close') ){
            $rs['code'] = 159;
        ...
        try {
            ...
            $orderId = $orderDomain->cancelOrder($data);
